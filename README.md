...
handle book returns, and monitor overdue books. The system is role-based access control to provide 
...
other hand, librarians have the authority to create, update, and delete user accounts, add new books to 
the catalog or remove outdated or damaged ones, generate reports, such as transaction histories, overdue 
books, and overall system usage. The Library Management System aims to automate the daily operations 
of a library, improving efficiency by reducing manual work and errors in managing books and transactions, 
provide easy access to books, and ensure security.
